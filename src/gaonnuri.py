...
def generate_svg_badge_with_embedded_logo(
    output_path="logo/gaonnuri_badge_en.svg",
    label="Gaonnuri",
    badge_color="#000000",
    text_color="#ffffff",
    logo_file_path="logo/gaonnuri_white.svg"  # 반드시 로컬 SVG 파일
):
    # SVG 배지 사이즈 설정
    badge_width = 120
    badge_height = 28
...
if __name__ == "__main__":
    generate_svg_badge_with_embedded_logo(
        output_path="badge/gaonnuri_badge_en.svg",
        label="Gaonnuri",
        badge_color="#000000",
        text_color="#ffffff",
        logo_file_path="logo/gaonnuri_white.svg"
    )
